...
@interface NGAppBlockerHandlerTests : XCTestCase

@end

@implementation NGAppBlockerHandlerTests
...
- (void)testSharedInstance {
    ...
    NGAppBlockHandler *instanceOne = [NGAppBlockHandler sharedInstance];
    NGAppBlockHandler *instanceTwo = [NGAppBlockHandler sharedInstance];
    ...
    //Alloc
    instanceOne = [[NGAppBlockHandler alloc] init];
