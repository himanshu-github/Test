...
#import "NGAnimator.h"
@interface NGAnimatorTests : XCTestCase

@end

@implementation NGAnimatorTests
...
- (void)testSharedInstance {
    ...
    NGAnimator *instanceOne = [NGAnimator sharedInstance];
    NGAnimator *instanceTwo = [NGAnimator sharedInstance];
    ...
    //Alloc
    instanceOne = [[NGAnimator alloc] init];
