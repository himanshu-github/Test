...
+(NSDate*)createNewDateFromDate:(NSDate*)paramFromDate ForHour:(NSUInteger)paramHour AndForMinute:(NSUInteger)paramMinute{
    ...
    NSDateComponents *dateComponents = [calendar components:(NSDayCalendarUnit | NSMonthCalendarUnit |
                                                             NSYearCalendarUnit | NSHourCalendarUnit | NSMinuteCalendarUnit) fromDate:paramFromDate];
...
+ (NSDateComponents *)getCurrentDateComponents{
    ...
    NSDateComponents* components = [calendar components:NSMonthCalendarUnit | NSYearCalendarUnit | NSDayCalendarUnit fromDate:[NSDate date]];
...
{
    // Convert string to date object
    NSDate *date = [NGDateManager dateFromString:dateStr WithDateFormat:@"MM/dd/yyyy"];
