...
+(NSManagedObjectContext*)privateMoc{
    ...
    if ([self class] == [NGDynamicCoreDataHelper class])
    temporaryContext.parentContext = [[NGCoreDataHelper sharedInstance] managedObjectContext];
    else if ([self class] == [NGStaticDDHelper class])
    temporaryContext.parentContext = [[NGStaticDDCoreDataLayer sharedInstance] managedObjectContext];
    else
        temporaryContext.parentContext = [[NGCoreDataHelper sharedInstance] managedObjectContext];
